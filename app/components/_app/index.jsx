    ...
    useEffect(() => {
        ...
        const fetchStore = async () => {
            const res = await fetch(
                `http://localhost:3000/mobify/proxy/ocapi/s/RefArch/dw/shop/v20_2/stores?latitude=${GEO_LOCATION.lat}&longitude=${GEO_LOCATION.long}&client_id=bf54d5e5-2349-4cf2-bcba-b9b9feb73733`
            )
            if (res.ok) {
