...
jest.mock('../universal/routes', () => {
  ...
  const {
    useServerContext
  } = require('../universal/hooks'); // Test utility to exercise paths that work with @loadable/component.
...
describe('The Node SSR Environment', () => {
  ...
  const cases = [{
    ...
    assertions: res => {
      expect(res.statusCode).toBe(404); // we'll expect that this method is called three times,
