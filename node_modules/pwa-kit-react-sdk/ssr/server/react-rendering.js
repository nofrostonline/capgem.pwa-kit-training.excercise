...
const render = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (req, res, next) {
    const AppConfig = (0, _compatibility.getAppConfig)(); // Get the application config which should have been stored at this point.
    ...
    const component = yield route.component.getComponent(); // Step 3 - Init the app state
...
const renderApp = args => {
  ...
  let routerContext;
  let appHtml;
  let renderError; // It's important that we render the App before extracting the script elements,
  ...
  const helmet = _reactHelmet.Helmet.renderStatic(); // Return the first error encountered during the rendering pipeline.


  const error = appStateError || renderError; // Remove the stacktrace when executing remotely as to not leak any important
