...
const withErrorHandling = Wrapped => {
  ...
  const WithErrorHandling = props => /*#__PURE__*/_react.default.createElement(_appErrorBoundary.AppErrorContext.Consumer, null, ctx => /*#__PURE__*/_react.default.createElement(Wrapped, _extends({}, props, ctx))); // Expose statics from the wrapped component on the HOC
  ...
  class RouteComponent extends _react.default.Component {
    ...
    componentDidUpdate(previousProps) {
      ...
      return _asyncToGenerator(function* () {
        ...
        } = previousMatch || {}; // The wasHydratingOnUpdate flag MUST only be used to decide whether
        ...
        const emitPageErrorEvent = (name, content) => isPage && _events.pages.error(name, content); // If hydrating, we know that the server just fetched and
