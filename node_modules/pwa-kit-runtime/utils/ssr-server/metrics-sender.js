...
class MetricsSender {
  constructor() {
    ...
    this._CW = null; // A queue of metrics waiting to be sent. Each is a single
  ...
  flush() {
    ...
    const promises = []; // Get a CloudWatch client (this will be falsy if we're not
    // really sending)
    ...
    while (this._queue.length) {
      ...
      this._queue = this._queue.slice(20); // Send the metrics
