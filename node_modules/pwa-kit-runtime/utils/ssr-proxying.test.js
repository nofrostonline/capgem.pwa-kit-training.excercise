...
describe('rewriteProxyResponseHeaders tests', () => {
  const tooLongUrlBase = 'https://www.customer.com/xyz?xyz='; // Because this string is based on tooLongUrlBase,
...
describe('rewriteProxyRequestHeaders tests', () => {
  ...
  testCases.forEach((testCase, testCaseIndex) => test(testCase.name || `test ${testCaseIndex}`, () => {
    const headers = _extends({}, testCase.input || {}); // If we're testing the allowlist, add a value for
